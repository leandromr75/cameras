...
namespace WindowsFormsApplication1
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
           /* if (dia != DateTime.Now.Day && DateTime.Now.Minute == 1 && DateTime.Now.Second <= 4)
            {
                timer1.Enabled = false;
        ...
        private void timer6_Tick(object sender, EventArgs e)
        {
            ...
            {
                writer = new VideoFileWriter();
                writer.Open("c://Record//Frente//frente dia " + DateTime.Now.Day.ToString() + " hora " + DateTime.Now.Hour.ToString() + " minutos " + DateTime.Now.Minute.ToString() + ".avi", width, height, 5, VideoCodec.H264, 180000);
                _statusTextBox.Text = "Gravando";


                writer2 = new VideoFileWriter();
                writer2.Open("c://Record//Escritório//escritório dia " + DateTime.Now.Day.ToString() + " hora " + DateTime.Now.Hour.ToString() + " minutos " + DateTime.Now.Minute.ToString() + ".avi", width, height, 5, VideoCodec.H264, 180000);
                _statusTextBox2.Text = "Gravando";

                writer3 = new VideoFileWriter();
                writer3.Open("c://Record//Escritório2//escritório2 dia " + DateTime.Now.Day.ToString() + " hora " + DateTime.Now.Hour.ToString() + " minutos " + DateTime.Now.Minute.ToString() + ".avi", width, height, 5, VideoCodec.H264, 180000);
                _statusTextBox3.Text = "Gravando";


                writer4 = new VideoFileWriter();
                writer4.Open("c://Record//Financeiro//financeiro dia " + DateTime.Now.Day.ToString() + " hora " + DateTime.Now.Hour.ToString() + " minutos " + DateTime.Now.Minute.ToString() + ".avi", width, height, 5, VideoCodec.H264, 180000);
                _statusTextBox4.Text = "Gravando";
